...
if __name__ == '__main__':
    ...
    unlabeled_train = pd.read_csv("/home/charch/gitwork/Word2Vec/data/unlabeledTrainData.tsv", header=0, delimiter="\t", quoting=3)
    ...
    model_name = "../result/300features_40minwords_10context"
